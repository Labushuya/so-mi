...
class TriggerDetector @Inject constructor() {
    ...
    companion object {
        ...
        private val PHRASES: List<TriggerPhrase> = listOf(
            ...
            // German — weitere Formulierungen
            TriggerPhrase("das ist wichtig"),
            TriggerPhrase("das solltest du wissen"),
            TriggerPhrase("das nicht vergessen"),
            TriggerPhrase("ich sage dir"),
            TriggerPhrase("ach ja:"),
            TriggerPhrase("wissenswertes:"),
            TriggerPhrase("zur info:"),
            TriggerPhrase("fyi:"),
            TriggerPhrase("btw:"),
            TriggerPhrase("nicht vergessen:"),
            TriggerPhrase("schreib auf"),
            TriggerPhrase("schreib dir auf"),
            TriggerPhrase("merk auf"),
            TriggerPhrase("behalte im kopf"),
            TriggerPhrase("wichtig zu wissen:"),
            TriggerPhrase("merke:"),
            // English
            ...
            TriggerPhrase("jot down"),
            TriggerPhrase("write this down"),
            TriggerPhrase("don't forget"),
            TriggerPhrase("heads up:"),
            TriggerPhrase("pro tip:"),
            // Slash-command
            TriggerPhrase("/note"),
            TriggerPhrase("/notiz"),
            TriggerPhrase("/merke"),
