...
interface InferenceEngine {
     ...
     * after the engine is initialised. Routed through the engine's
     * single-thread dispatcher so the sampler swap is serialised against
     * decode — safe to call mid-conversation; the new params take effect
     * on the next token batch.
     */
